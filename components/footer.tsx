        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/help" className="text-muted-foreground hover:text-primary transition-colors">Help & FAQ</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-muted-foreground text-sm">Email: support@taskoffice.com</li>
              <li className="text-muted-foreground text-sm">Phone: (555) 123-4567</li>
              <li className="text-muted-foreground text-sm">Hours: Mon-Fri 9AM-5PM</li>
            </ul>
          </div>
        </div>
