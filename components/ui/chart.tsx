...
// Define proper types for Recharts payload
...
// Custom Tooltip props that extend but don't conflict with Recharts
interface CustomTooltipProps {
  ...
  formatter?: (value: number, name: string, item: TooltipPayloadItem, index: number, payload: Record<string, unknown>) => React.ReactNode;
  color?: string;
  nameKey?: string;
  labelKey?: string;
}
    ...
    return (
      ...
      >
        {payload.map((item) => {
          ...
          return (
            <div
              key={item.value as string || item.dataKey as string}
              className={cn(
