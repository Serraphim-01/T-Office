  ...
  const fetchProducts = async () => {
    try {
      ...
      if (response.ok) {
        ...
        toast({
          title: 'Error',
          description: 'Failed to fetch outbound products',
          variant: 'destructive',
        });
      }
    } catch (error) {
      ...
      <DashboardLayout>
        <div className="flex items-center justify-center h-64">
          <div className="text-center">
            <p className="text-lg">Loading outbound products...</p>
          </div>
        </div>
      </DashboardLayout>
    );
    ...
    <DashboardLayout>
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Outbound Products</h1>
            <p className="text-gray-600">Manage outgoing, dispatched, and delivered products</p>
          </div>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center">
              ...
              Outbound Products ({products.length})
            </CardTitle>
          </CardHeader>
          <CardContent>
