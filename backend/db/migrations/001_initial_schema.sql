...
-- Description: Initial database schema for T-Office

-- This migration represents the complete initial schema for the T-Office application
-- It includes all tables, indexes, and initial data that were previously in create_migration.sql
...
CREATE INDEX IF NOT EXISTS idx_inbound_transactions_unit_price ON inbound_transactions(unit_price);
