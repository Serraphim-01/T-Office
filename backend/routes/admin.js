...
router.get("/pages", authenticateJWT, async (req, res) => {
  try {
    ...
    const pages = [
      ...
      { name: 'approvals', title: 'Approvals Dashboard' },
      ...
      { name: 'inventory/inbound/add-transaction', title: 'Inventory Inbound - Add Transaction' },
      { name: 'inventory/inbound/edit-transaction', title: 'Inventory Inbound - Edit Transaction' },
      ...
      { name: 'resources/wiki/create', title: 'Resources Wiki - Create' },
